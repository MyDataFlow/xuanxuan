...
除了使用上面提供的已部署的浏览器版本，你还可以将喧喧浏览器版本部署到你自己的服务器。下面以 1.4.0 版本为例：

1. 下载 [xuanxuan.1.4.0.browser.zip](http://dl.cnezsoft.com/xuanxuan/1.2/xuanxuan.1.4.0.browser.zip) 浏览器版本部署所需的所有文件；
