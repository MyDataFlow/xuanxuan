        ...
        >
            <ChatTitle className="flex-none gray has-padding-h" chat={chat}>
                <nav className="toolbar flex flex-middle">
                    ...
                    <div data-hint={Lang.string('chats.history.fetchFromServer')} className="hint--bottom-left"><button onClick={this.handleFecthBtnClick} type="button" disabled={this.state.loading} className="iconbutton btn rounded"><Icon name="cloud-download"/></button></div>
                </nav>
            </ChatTitle>
